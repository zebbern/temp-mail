...
class EmailListItem(QtWidgets.QWidget):
    ...
    def __init__(self, email: str, count: int, service: str, created_at=None, expiry_seconds=3600, parent=None):
        ...
        # Info row with message count and timer
...
class TempMailApp(QtWidgets.QMainWindow):
    ...
    def _init_ui(self):
        ...
        back1.clicked.connect(self._show_inbox_page)  # Change this to go back to inbox instead of home
    ...
    def _get_service_expiry(self, service_key: str) -> int:
        ...
        expiry_map = {
            ...
            'mailgw': 86400,          # 24 hours
            'dropmail': 3600,         # 1 hour
            'mailtm': 86400,          # 24 hours
    ...
    async def _show_message(self, mail_id: str):
        ...
        try:
            ...
            logging.info(f"Raw message content type: {type(html)}")
